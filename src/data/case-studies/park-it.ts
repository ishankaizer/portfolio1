...
export const parkIt: CaseStudy = {
  ...
  process: [
    ...
    },
    {
      ...
      body: [
        ...
        'That reframing set the priority order: availability you can trust → reservation → turn-by-turn to the exact lot → frictionless payment and a scannable e-ticket.',
      ],
    },
    {
      ...
      body: [
        ...
        'An in-app wallet and e-tickets remove the cash friction attendants complained about, and SMS fallback covers the reality that not every user keeps the app open or has steady data.',
      ],
  ...
  decisions: [
    ...
    },
    {
      ...
      body: 'Designing only for the happy path ignores patchy data and older phones. Booking confirmations and e-tickets fall back to SMS so the system still works when the app doesn’t — an industrial-design habit of designing for the real environment, not the demo.',
    },
  ],
  outcome: {
    body: [
      ...
      'The project became my clearest demonstration of end-to-end product thinking — from field research in three cities to a validated, high-fidelity flow — and a reusable mobile UI system.',
    ],
  },
  reflection: [
