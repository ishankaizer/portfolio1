  ...
  process: [
    {
      ...
      body: [
        'I grounded the design in the constraints of ageing hands and eyes: reduced grip strength, tremor, lower contrast sensitivity. That drove decisions before any styling, from button size and actuation force to text size and the loudness and pitch of alerts.',
