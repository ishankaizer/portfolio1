...
export const levelstretch: CaseStudy = {
  ...
  decisions: [
    ...
    },
    {
      ...
      body: 'The receiving app will only ever be read in a hurry. I designed it to communicate the one thing that matters, how urgent and how soon, at a glance, and let detail come second. Calm information design for a high-stress moment.',
    },
  ],
  outcome: {
    body: [
