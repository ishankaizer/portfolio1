  ...
  process: [
    {
      ...
      body: [
        ...
        'Consistent, honest product visualization was non-negotiable: a material chosen on-screen has to match the material that arrives. I built a visualization treatment so lighting and scale stay comparable across the whole catalogue.',
      ],
    ...
    },
    {
      ...
      body: [
        'This is where the project earns its place: I didn’t stop at screens. I built the front-end in React, which meant confronting the real problems mockups hide — loading states, empty states, responsive behaviour, and how the grid performs with a lot of imagery.',
    ...
    },
    {
      ...
      body: [
        'A material platform lives or dies on its catalogue, and catalogues mean thousands of vendor images in inconsistent formats. I wrote Python to batch-process them into a clean, consistent set — the kind of leverage that lets a small team ship a big-feeling product.',
      ],
    },
  ],
  decisions: [
